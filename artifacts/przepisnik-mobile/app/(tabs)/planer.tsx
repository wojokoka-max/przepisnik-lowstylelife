      ...
      >
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroTitle}>
            Twój dzień <Text style={{ fontFamily: "CormorantGaramond_400Regular_Italic", color: "#C6A35B" }}>na talerzu</Text>
          </Text>
...
const styles = StyleSheet.create({
  ...
  macroRow: {
    ...
    maxWidth: 360,
    borderWidth: 1,
    borderColor: "rgba(198,163,91,0.12)",
  },
  ...
  kcalChipTextActive: { color: "#10141B", fontFamily: "Inter_700Bold" },
